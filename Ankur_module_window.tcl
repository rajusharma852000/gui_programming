...
proc update_comment {args} {
    global selected_pane selected_position  curr_dir main_file;# Access global variables
...
#bind .top.id_combo <KeyRelease> {filter_combobox}
