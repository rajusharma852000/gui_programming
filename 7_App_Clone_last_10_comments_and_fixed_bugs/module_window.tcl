...
proc next_tex {} {
    ...
    if {$current_index < [expr {[llength $tex_list] - 1}] } {
        ...
        #update widget and activity log
...
proc apply_dark_theme_recursive {widget} {
    ...
    -background gray20 -bordercolor black -arrowcolor white
...
proc toggle_theme { } {
     ...
     if {$theme eq "dark" } {
         ...
         add_Activity "Light Mode Applied";
         update_activity
     } else {
         set theme "dark";
         set switchToTheme "Light";
         ...
         # update the activity log
         add_Activity "Dark Mode Applied";
         update_activity
     }
...
-relief raised -command {
		sort_tex_list
		# update the activity log
		after 10 [add_Activity "Sorted by roll number"];
		after 10 update_activity;
	} 
radiobutton .top.rb2 -text "S" -variable choice -value "size" -font myFont \
-relief raised -command {
		sort_tex_list
		# update the activity log
		after 10 [add_Activity "Sorted by size"];
		after 10 update_activity;
	}  
...
button .left_comment.theme_btn -textvariable switchToTheme -font myFont -command {toggle_theme}
