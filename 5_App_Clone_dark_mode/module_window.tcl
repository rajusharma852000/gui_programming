...
proc apply_dark_theme_recursive {widget} {
    ...
    -background gray20 -bordercolor black -lightcolor pink -darkcolor purple -arrowcolor white
...
proc apply_light_theme_recursive {widget} {
    ...
    -background lightgray -foreground black -arrowcolor black
...
proc toggle_theme { } {
     global theme last_theme_file last_call_time;
...
button .left_comment.theme_btn -textvariable theme -font myFont -command {toggle_theme}
grid .left_comment.theme_btn -row 0 -column 0 -sticky w -padx 3 -pady 2
label .left_comment.label -text "Comment" -font myFont 
grid .left_comment.label -row 2 -column 0 -sticky w -padx 3 -pady 2
...
grid .left_comment.dropdown -row 4 -column 0 -sticky w -padx 3 -pady 2

button .left_comment.myButton1 -text "See Errors" -font myFont -width 7 -height 1 -command showError -state disabled
grid .left_comment.myButton1 -row 5 -column 0 -sticky w -padx 3 -pady 2
